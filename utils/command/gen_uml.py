...
#
# Create a UML 2.0 datamodel from the Dabbler 0.2.0 model file.
#
# To do this we do the following:
# 1. read the model file with the dabbler parser
...
from dabbler.storage.parser import parse, base, element
