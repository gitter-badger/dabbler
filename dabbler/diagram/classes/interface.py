...
`dabbler.diagram.connector` module documentation for details. *Documentation
...
For more examples of non-supported by Dabbler notation, see
...
from dabbler.diagram.style import ALIGN_TOP, ALIGN_BOTTOM, ALIGN_CENTER
