...
In Dabbler 0.8.x there was assembly connector item, with additional handles
...
For Dabbler 0.14 and later, two other ideas were considered.
...
consistent with the rest of Dabbler application but
...
from dabbler.diagram.diagramline import NamedLine
from dabbler.diagram.style import ALIGN_CENTER, ALIGN_BOTTOM
