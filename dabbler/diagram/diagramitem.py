...
from dabbler.services.elementdispatcher import EventWatcher
from dabbler.core import inject
from dabbler.diagram import DiagramItemMeta
from dabbler.diagram.textelement import EditableTextSupport
from dabbler.diagram.style import ALIGN_CENTER, ALIGN_TOP
import six
...
class DiagramItem(six.with_metaclass(DiagramItemMeta, uml2.Presentation, StereotypeSupport, EditableTextSupport)):
    ...
    diacanvas.DiaCanvasItem and dabbler.UML.uml2.Element.
    ...
    def request_update(self):
        """
        Placeholder for dabbler.Item's request_update() method.
        """
        pass
