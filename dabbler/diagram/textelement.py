...
from dabbler.diagram.style import Style
...
class EditableTextSupport(object):
    ...
    def post_update(self, context):
        ...
        for txt in texts:
            ...
            bounds = txt.bounds # fixme: dabbler rectangle problem
            width, height = bounds.width, bounds.height # fixme: dabbler rectangle problem
            txt.bounds.x = x
            txt.bounds.y = y
