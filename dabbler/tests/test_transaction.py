...
"""Unit tests for transactions in Dabbler."""
...
from dabbler.transaction import Transaction, TransactionError
...
class TransactionTestCase(TestCase):
    ...
    def setUp(self):
        """Initialize Dabbler services and register transaction event
        handlers."""
