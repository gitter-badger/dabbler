...
from dabbler.UML.element import Element
from dabbler.UML.event import ElementCreateEvent, ElementDeleteEvent, FlushFactoryEvent, ModelFactoryEvent
from dabbler.UML.interfaces import IElementChangeEvent
from dabbler.UML.uml2 import Diagram
from dabbler.core import inject
from dabbler.interfaces import IService, IEventFilter
from dabbler.misc import odict
...
class ElementFactoryService(ElementFactory):
    ...
    def flush(self):
        ...
        if the element factory has a Dabbler application instance.  If yes,
    ...
    def notify_model(self):
        ...
        ModelFactoryEvent event from dabbler.UML.event.
        """
