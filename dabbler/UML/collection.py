...
from dabbler.UML.event import AssociationChangeEvent
from dabbler.misc.listmixins import querymixin, recursemixin, getslicefix
...
class collectionlist(recursemixin, querymixin, getslicefix, list):
    ...
    [<dabbler.UML.uml2.Operation object at 0x...>]
