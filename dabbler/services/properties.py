...
"""The properties module allows Dabbler properties to be saved to the local
...
class Properties(object):
    ...
    def __init__(self, backend=None):
        """Constructor.  Initialize the Dabbler application object, the
...
class FileBackend(object):
    ...
    def get_filename(self, create=False):
        """Return the current file used to store Dabbler properties.  If the
