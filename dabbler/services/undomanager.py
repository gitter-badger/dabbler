...
from dabbler.UML.event import ElementCreateEvent, ElementDeleteEvent, \
    AssociationSetEvent, \
    AssociationAddEvent, AssociationDeleteEvent
from dabbler.UML.interfaces import IElementDeleteEvent, \
    IAttributeChangeEvent, IModelFactoryEvent
from dabbler.action import action, build_action_group
from dabbler.core import inject
from dabbler.event import ActionExecuted
from dabbler.event import TransactionBegin, TransactionCommit, TransactionRollback
from dabbler.interfaces import IService, IServiceEvent, IActionProvider
...
class UndoManager(object):
    """
    Simple transaction manager for Dabbler.
