...
from dabbler.services.undomanager import UndoManager
...
class TestUndoManager(TestCase):
    ...
    def test_undo_attribute(self):
        from dabbler.UML.properties import attribute
    ...
    def test_undo_association_1_x(self):
        from dabbler.UML.properties import association
        from dabbler.UML.element import Element
        undo_manager = UndoManager()
        undo_manager.init(Application)
    ...
    def test_uml_associations(self):
        ...
        from dabbler.UML.interfaces import IAssociationChangeEvent
        from dabbler.UML.properties import association, derivedunion
        from dabbler.UML.element import Element
