...
from dabbler.UML.interfaces import IAssociationSetEvent, IAssociationAddEvent, IAssociationDeleteEvent
from dabbler.UML.interfaces import IElementChangeEvent, IModelFactoryEvent
...
class ElementDispatcher(object):
    ...
    that's represented by this item (dabbler.UML.uml2.Transition), you can register
    a handler like this::
