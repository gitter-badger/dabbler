...
to folded interface, see `dabbler.diagram.classes.interface` documentation
for details.
"""
...
from dabbler.adapters.classes.classconnect import DependencyConnect, ImplementationConnect
