...
from dabbler.event import ServiceInitializedEvent, ServiceShutdownEvent
...
class _Application(object):
    """
    The Dabbler application is started from the Application instance. It behaves
    ...
    def load_services(self, services=None):
        ...
        Service should provide an interface dabbler.interfaces.IService.
        """
        ...
        for ep in pkg_resources.iter_entry_points('dabbler.services'):
            cls = ep.load()
    ...
    distribution = property(lambda s: pkg_resources.get_distribution('dabbler'),
                            doc='Get the PkgResources distribution for Dabbler')
