...
class StorageTestCase(TestCase):
    def test_version_check(self):
        from dabbler.storage.storage import version_lower_than
    ...
    def test_save_uml(self):
        """Saving dabbler.uml2 model elements.
        """
    ...
    def test_load_uml_metamodel(self):
        ...
        dist = pkg_resources.get_distribution('dabbler')
        path = os.path.join(dist.location, 'dabbler/UML/uml2.dabbler')
    ...
    def test_load_save(self):
        ...
        dist = pkg_resources.get_distribution('dabbler')
        path = os.path.join(dist.location, 'test-diagrams/simple-items.dabbler')
        ...
        with open('tmp.dabbler', 'w') as ofile:
            ofile.write(copy)

        expr = re.compile('dabbler-version="[^"]*"')
...
class FileUpgradeTestCase(TestCase):
    def test_association_upgrade(self):
        """Test association navigability upgrade in Dabbler 0.15.0
        """

        dist = pkg_resources.get_distribution('dabbler')
        path = os.path.join(dist.location, 'test-diagrams/associations-pre015.dabbler')
    ...
    def test_tagged_values_upgrade(self):
        """Test tagged values upgrade in Dabbler 0.15.0
        """

        dist = pkg_resources.get_distribution('dabbler')
        path = os.path.join(dist.location, 'test-diagrams/taggedvalues-pre015.dabbler')
    ...
    def test_lifeline_messages_upgrade(self):
        """Test message occurrence specification upgrade in Dabbler 0.15.0
        """

        dist = pkg_resources.get_distribution('dabbler')
        path = os.path.join(dist.location, 'test-diagrams/lifelines-pre015.dabbler')
