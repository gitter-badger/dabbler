...
from dabbler.core import _, inject, action, toggle_action, open_action, build_action_group, transactional
...
from dabbler.UML.event import ModelFactoryEvent
from .event import DiagramTabChange, DiagramSelectionChange
from dabbler.services.filemanager import FileManagerStateChanged
from dabbler.services.undomanager import UndoManagerStateChanged
from dabbler.ui.accelmap import load_accel_map, save_accel_map
...
class MainWindow(object):
    ...
    def init_stock_icons(self):
        # Load stock items
        import dabbler.ui.stock
        dabbler.ui.stock.load_stock_icons()


    def init_ui_components(self):
        component_registry = self.component_registry
        for ep in pkg_resources.iter_entry_points('dabbler.uicomponents'):
    ...
    def open(self):
        ...
        # set default icons of dabbler windows
        icon_dir = os.path.abspath(pkg_resources.resource_filename('dabbler.ui', 'pixmaps'))
        ...
        filename = pkg_resources.resource_filename('dabbler.ui', 'layout.xml')
...
gtk.accel_map_add_filter('dabbler')
...
class Namespace(object):
    ...
    @action(name='tree-view-create-diagram', label=_('_New diagram'), stock_id='dabbler-diagram')
    @transactional
    ...
    @action(name='tree-view-create-package', label=_('New _package'), stock_id='dabbler-package')
    @transactional
