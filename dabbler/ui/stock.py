...
"""Icons that are used by Dabbler.
"""
...
from dabbler.storage.parser import ParserException

XMLNS = 'http://dabbler.sourceforge.net/dabbler/stock-icons'
