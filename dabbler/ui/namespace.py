...
from dabbler.UML.event import ElementCreateEvent, ModelFactoryEvent, FlushFactoryEvent, DerivedSetEvent
...
class NamespaceView(gtk.TreeView):
    ...
    DND_TARGETS = [
        ...
        ('dabbler/element-id', 0, TARGET_ELEMENT_ID)]
    ...
    def on_drag_drop(self, context, x, y, time):
        ...
        """
        if 'dabbler/element-id' in context.targets:
