...
from dabbler.core import _, inject, transactional, action, build_action_group
from dabbler.UML.interfaces import IAttributeChangeEvent, IElementDeleteEvent
from dabbler.diagram import get_diagram_item
from dabbler.diagram.items import DiagramItem
from dabbler.transaction import Transaction
from dabbler.ui.diagramtoolbox import DiagramToolbox
from dabbler.ui.event import DiagramSelectionChange
...
class DiagramTab(object):
    ...
    VIEW_DND_TARGETS = [
        ('dabbler/element-id', 0, VIEW_TARGET_ELEMENT_ID),
        ('dabbler/toolbox-action', 0, VIEW_TARGET_TOOLBOX_ACTION)]
    ...
    def construct(self):
        ...
        item = DockItem(title=self.title, stock_id='dabbler-diagram')
