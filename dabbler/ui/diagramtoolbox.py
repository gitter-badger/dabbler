...
from dabbler.UML.event import DiagramItemCreateEvent
from dabbler.UML import uml2
from dabbler.diagram import items
from dabbler.core import _, inject, radio_action, build_action_group
...
TOOLBOX_ACTIONS = (
    ('', (
        ('toolbox-pointer', _('Pointer'), 'dabbler-pointer', 'Escape'),
        ('toolbox-line', _('Line'), 'dabbler-line', 'l'),
        ('toolbox-box', _('Box'), 'dabbler-box', 'b'),
        ('toolbox-ellipse', _('Ellipse'), 'dabbler-ellipse', 'e'),
        ('toolbox-comment', _('Comment'), 'dabbler-comment', 'k'),
        ('toolbox-comment-line', _('Comment line'), 'dabbler-comment-line', 'K'),
    )), (_('Classes'), (
        ('toolbox-class', _('Class'), 'dabbler-class', 'c'),
        ('toolbox-interface', _('Interface'), 'dabbler-interface', 'i'),
        ('toolbox-package', _('Package'), 'dabbler-package', 'p'),
        ('toolbox-association', _('Association'), 'dabbler-association', 'A'),
        ('toolbox-dependency', _('Dependency'), 'dabbler-dependency', 'D'),
        ('toolbox-generalization', _('Generalization'), 'dabbler-generalization', 'G'),
        ('toolbox-implementation', _('Implementation'), 'dabbler-implementation', 'I'),
    )), (_('Components'), (
        ('toolbox-component', _('Component'), 'dabbler-component', 'o'),
        ('toolbox-artifact', _('Artifact'), 'dabbler-artifact', 'h'),
        ('toolbox-node', _('Node'), 'dabbler-node', 'n'),
        ('toolbox-device', _('Device'), 'dabbler-device', 'd'),
        ('toolbox-subsystem', _('Subsystem'), 'dabbler-subsystem', 'y'),
        ('toolbox-connector', _('Connector'), 'dabbler-connector', 'C'),
    )), (_('Actions'), (
        ('toolbox-action', _('Action'), 'dabbler-action', 'a'),
        ('toolbox-initial-node', _('Initial node'), 'dabbler-initial-node', 'j'),
        ('toolbox-activity-final-node', _('Activity final node'), 'dabbler-activity-final-node', 'f'),
        ('toolbox-flow-final-node', _('Flow final node'), 'dabbler-flow-final-node', 'w'),
        ('toolbox-decision-node', _('Decision/merge node'), 'dabbler-decision-node', 'g'),
        ('toolbox-fork-node', _('Fork/join node'), 'dabbler-fork-node', 'R'),
        ('toolbox-object-node', _('Object node'), 'dabbler-object-node', 'O'),
        ('toolbox-partition', _('Partition'), 'dabbler-partition', 'P'),
        ('toolbox-flow', _('Control/object flow'), 'dabbler-control-flow', 'F'),
        ('toolbox-send-signal-action', _('Send signal action'), 'dabbler-send-signal-action', None),
        ('toolbox-accept-event-action', _('Accept event action'), 'dabbler-accept-event-action', None),
    )), (_('Interactions'), (
        ('toolbox-lifeline', _('Lifeline'), 'dabbler-lifeline', 'v'),
        ('toolbox-message', _('Message'), 'dabbler-message', 'M'),
        ('toolbox-interaction', _('Interaction'), 'dabbler-interaction', 'N'),
    )), (_('States'), (
        ('toolbox-state', _('State'), 'dabbler-state', 's'),
        ('toolbox-initial-pseudostate', _('Initial Pseudostate'), 'dabbler-initial-pseudostate', 'S'),
        ('toolbox-final-state', _('Final State'), 'dabbler-final-state', 'x'),
        ('toolbox-history-pseudostate', _('History Pseudostate'), 'dabbler-history-pseudostate', 'q'),
        ('toolbox-transition', _('Transition'), 'dabbler-transition', 'T'),
    )), (_('Use Cases'), (
        ('toolbox-usecase', _('Use case'), 'dabbler-usecase', 'u'),
        ('toolbox-actor', _('Actor'), 'dabbler-actor', 't'),
        ('toolbox-usecase-association', _('Association'), 'dabbler-association', 'B'),
        ('toolbox-include', _('Include'), 'dabbler-include', 'U'),
        ('toolbox-extend', _('Extend'), 'dabbler-extend', 'X'),
    )), (_('Profiles'), (
        ('toolbox-profile', _('Profile'), 'dabbler-profile', 'r'),
        ('toolbox-metaclass', _('Metaclass'), 'dabbler-metaclass', 'm'),
        ('toolbox-stereotype', _('Stereotype'), 'dabbler-stereotype', 'z'),
        ('toolbox-extension', _('Extension'), 'dabbler-extension', 'E'),
    )),
    )
