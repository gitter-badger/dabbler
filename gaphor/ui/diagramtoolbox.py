...
class DiagramToolbox(object):
    ...
    @radio_action(names=next(zip(*list(itemiter(TOOLBOX_ACTIONS)))),
                  labels=next(zip(*list(itemiter(TOOLBOX_ACTIONS)))),
                  stock_ids=next(zip(*list(itemiter(TOOLBOX_ACTIONS)))))
