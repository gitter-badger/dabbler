...
class NodeComponentGroupTestCase(TestCase):
    ...
    def test_grouping(self):
        ...
        self.assertEqual(2, len(self.kindof(uml2.ConnectorEnd)))
    ...
    def test_ungrouping(self):
        ...
        self.assertEqual(0, len(self.kindof(uml2.Property)))
        self.assertEqual(0, len(self.kindof(uml2.Connector)))
        self.assertEqual(0, len(self.kindof(uml2.ConnectorEnd)))
...
class NodeArtifactGroupTestCase(TestCase):
    ...
    def test_ungrouping(self):
        ...
        self.assertEqual(0, len(self.kindof(uml2.Deployment)))
...
class PartitionGroupTestCase(TestCase):
    ...
    def test_nested_subpartition_ungrouping(self):
        ...
        self.assertTrue(p3.subject is not None, p3.subject)
        self.assertTrue(p4.subject is not None, p4.subject)
        self.assertEqual(2, len(self.kindof(uml2.ActivityPartition)))
    ...
    def test_nested_subpartition_regrouping(self):
        ...
        self.group(p1, p2)
        self.assertEqual(3, len(self.kindof(uml2.ActivityPartition)))
        self.assertTrue(p2.subject is not None, p2.subject)
        self.assertTrue(p3.subject is not None, p3.subject)
        self.assertTrue(p4.subject is not None, p4.subject)
